package tn.idrm.gateway.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof tn.idrm.gateway.service.EmailAlreadyUsedException ||
            ex instanceof tn.idrm.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof tn.idrm.gateway.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "tn.idrm.gateway");
    }
}
